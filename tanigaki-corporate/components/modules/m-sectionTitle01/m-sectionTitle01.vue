<template lang="pug">
	h2.m-sectionTitle01(:class='`${className}`')
		span.is-jp
			span {{ jp }}
		span.is-en
			span {{ en }}
...
<style lang="stylus">
	...
	.m-sectionTitle01
		...
		&.is-middle
			&>span
				&.is-jp
					font-size clamp(1.3rem, 3cqw, 3.0rem)
				&.is-en
					font-size clamp(4.5rem, 7.5cqw, 9.0rem)
		...
		&>span
			...
			&.is-jp
				color rgba(#040278, 0.8)
				font-size clamp(2.0rem, 4cqw, 4.0rem)
				font-weight bold
				line-height 1.0
				z-index 100
