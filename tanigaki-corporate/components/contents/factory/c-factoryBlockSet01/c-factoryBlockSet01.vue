<template lang="pug">
	.factoryBlockSet01_wrapper
		.js-inviewPoint
			section.c-factoryBlockSet01.is-contentsLeft
				.componentWrapper
					.l-contentsWrapper
						.l-mqWrapper
							.block.is-content
...
<script>
	...
	let thumbnailSlider = [];
	export default {
		name: 'c-factoryBlockSet01',
		mounted() {

			let target = document.querySelectorAll('.c-factoryBlockSet01 .block.is-lists');
...
<style lang="stylus">
	...
	.c-factoryBlockSet01
		&:last-child
			...
			.block.is-lists
				margin-top clamp(-60px, -13svw, -200px)
				...
				.swiper-slide
					...
					.title
						margin-top 4%
						color #E02400
						font-size clamp(1.2rem, 2.5cqw, 1.6rem)
						font-weight bold
					
					.text
						margin-top 2%
						font-size clamp(1.0rem, 2cqw, 1.4rem)
</style>